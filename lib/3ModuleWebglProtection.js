var backgroundModule3 = (function () {
  var tmp = {};
    ...
    if (sender.tab && sender.tab.id) {
      for (var id in tmp) {
        if (tmp[id] && typeof tmp[id] === "function") {
          if (request.path === "background-to-page" && request.tabId === sender.tab.id) {
        ...
        buffer: function (target) {
          ...
          Object.defineProperty(target.prototype, "bufferData", {
            value: function () {
              ...
              window.top.postMessage("webgl-fingerprint-defender-alert", "*", [arguments[1]]);
              //
        ...
        parameter: function (target) {
          ...
          Object.defineProperty(target.prototype, "getParameter", {
            value: function () {
              ...
              window.top.postMessage("webgl-fingerprint-defender-alert", "*", [float32array]);
              //
...
var scriptModule3 = document.createElement("script");
scriptModule3.textContent = "(" + injectModule3 + ")()";
document.documentElement.appendChild(scriptModule3);

if (document.documentElement.dataset.wgscriptallow !== "true") {
  var scriptModule3Iframe = document.createElement("script");
  scriptModule3Iframe.textContent = `{
  ...
  window.top.document.documentElement.appendChild(scriptModule3Iframe);
}

window.addEventListener("message", function (e) {
  if (e.origin === window.origin && e.data && e.data === "webgl-fingerprint-defender-alert") {
    backgroundModule3.send("fingerprint", { host: document.location.host });
  }
}, false);
